    ...
    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row">
            <?php if($post->post_thumbnail): ?>
                <div class="col-sm-4">
                    <img src="/fsr-cms/public/uploads/<?php echo e($post->post_thumbnail); ?>" alt="Istaknuta Slika"
            ...
            <div class="col-sm-8">
                <div class="blog-post">
                    <h2 class="blog-post-title">
                        <a href="/fsr-cms/public/show/<?php echo e($post->id); ?>" class="blog-post-title"><?php echo e($post->title); ?></a>
                    </h2>
                    <p class="blog-post-meta">
                        ...
                        <?php if($post->categories()->count()>0): ?>
                            ...
                            <?php $__currentLoopData = $post->categories->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="/fsr-cms/public/category/<?php echo e($category); ?>"><?php echo e($category); ?></a>
