        ...
        <div class="col-md-6" style="margin-top:-30px">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <form method="POST" action="<?php echo e(('/fsr-cms/public/reminder/create')); ?>">
                ...
                <div class="box-body">
                    <ul class="todo-list">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                ...
                                <div class="tools">
                                    <a href="/fsr-cms/public/reminder/edit/<?php echo e($reminder->id); ?>"><i class="fa fa-edit"></i></a>
                                    <a href="/fsr-cms/public/reminder/delete/<?php echo e($reminder->id); ?>"> <i class="fa fa-trash-o"></i></a>
                                </div>
                            </li>
