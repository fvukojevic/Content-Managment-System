                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <form method="POST" action="<?php echo e(url('/ctg/create')); ?>">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(url('/admin/category/edit/')); ?>/<?php echo e($category->id); ?>"><span
                                                        class="label label-warning">UREDI</span></a>
                                            <a href="<?php echo e(url('/admin/ctg/delete/')); ?>/<?php echo e($category->id); ?>"><span
